...
//ตัวแปรเก็บข้อมูลที่จะเอาไปใช้กับ carousel
  ...
  //ตัวแปรเก็บข้อมูลแต่ละร้านที่จะเอาไปใช้ในส่วนของ ListView
        ...
        child: Column(
          children: [
            ...
            CarouselSlider.builder(
              itemCount: _imgCakeShop.length, // จำนวน ภาพที่ต้องการใช้แสดง .length ใช้นับจำนวนตัวแปรที่มี
              options: CarouselOptions(
                height: MediaQuery.of(context).size.height * 0.25,
                enlargeCenterPage: true, //แสดงอยู่ตรงกลาง
                enableInfiniteScroll: true, //ให้หมุนวนไปเรื่อย ๆ
                autoPlay: true,
                autoPlayInterval: Duration(seconds: 3), //เปลี่ยนรูปทุกกี่วินาที
            ...
            Expanded(
              child: ListView.separated(
                //listview แบบมีเส้นแบ่ง
                separatorBuilder: (context, index) {
                  return Divider(
                    color: Colors.grey[700],
                  );
                },
                itemCount: _cakeShop.length, //จำนวนรายการ
                itemBuilder: (context, index) {
                  //สร้างแบบ รายการ
                  return ListTile(
                    //properties นี้สามารถ กดได้ ใส่รูปได้ ใส่ข้อความ รายละเอียดได้
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                    ...
                    leading: Image.asset(
                      //กำหนดด้านซ้ายสุด เช่น รูป
                      'assets/images/' + _cakeShop[index].image1!, //เพราะไม่ได้อ้างตำแหน่งที่อยู่รูป
                    ),
                    title: Text(
                      //กำหนดด้านบนสุด
                    ...
                    subtitle: Text(
                      //กำหนดด้านล่างสุด เช่น รายละเอียด
                      'เวลาทำการ' + _cakeShop[index].openCloseTime!,
                      style: GoogleFonts.kanit(),
                    ),
                    trailing: Icon(
                      //กำหนดด้านขวาสุด เช่น ลูกศร
